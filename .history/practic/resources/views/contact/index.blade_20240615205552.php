    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            ...
            <div>
                ...
                <input id="email_confirmation" placeholder="メールアドレスの確認 必須"  type="email" name="email_confirmation"  class="form-control @error('email') is-invalid @enderror" name="email_confirmation" value="{{ old('email') }}" required autocomplete="email" autofocus>
