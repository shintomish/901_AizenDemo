...
@section('content')
    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            @csrf
            <label for="name">{{ __('お名前') }}<span class="badge badge-danger ml-2">{{ __('必須') }}</span></label>
            ...
            <label for="age">{{ __('年齢') }}<span class="badge badge-danger ml-2">{{ __('必須') }}</span></label>
            ...
            <div class="form-group">
                <label for="sex-id">{{ __('性別') }}<span class="badge badge-danger ml-2">{{ __('必須') }}</span></label>
            ...
            <div>
                <label for="body">{{ __('お問い合わせ内容') }}<span class="badge badge-danger ml-2">{{ __('必須') }}</span></label>
