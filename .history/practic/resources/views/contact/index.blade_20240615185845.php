    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            ...
            <div>
                ...
                <textarea id="body"   placeholder="メールアドレス 必須" class="form-control" type="text" name="body">{{ old('body') }}</textarea>
                @if($errors->has('body'))
            ...
            <div>
                ...
                <button type="submit" class="w-100 btn btn-lg btn-primary" name="submitBtnVal" value="confirm">確認画面へ</button>
            </div>
