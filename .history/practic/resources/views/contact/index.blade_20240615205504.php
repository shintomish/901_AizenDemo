    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            ...
            <div>
                ...
                <input id="email" placeholder="メールアドレス 必須" name=" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            </div>

            <div>
                <label for="email_confirmation"></label>
                <input id="email_confirmation" placeholder="メールアドレスの確認 必須"  type="email" name="email_confirmation" value="{{ old('email_confirmation') }}" required autocomplete="email" autofocus>
