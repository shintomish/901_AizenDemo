...
@section('content')
    ...
    <section>
        ...
        <label  style="margin-bottom:20px;" for="1"></label>
        <label  style="margin-bottom:120px;" for="2"></label>
        <label for="3"></label>
        <label for="4"></label>
        <label for="5"></label>
        <label for="6"></label>
        <h3>
            <label for="3" style="margin-bottom:10px;" class="text-success">お問い合わせ完了</label>
        </h3>
