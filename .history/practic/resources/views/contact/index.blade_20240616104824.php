    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            ...
            <div>
                ...
                <input id="name" style="margin-bottom:10px;"  placeholder="お名前 必須"  type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
            </div>

            <div>
                {{-- <label for="age"></label> --}}
                <input id="age"  style="margin-bottom:10px;" placeholder="年齢 必須"  type="text" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ old('age') }}" required autocomplete="age" autofocus>
            </div>
            ...
            <div>
                ...
                <input id="email"  style="margin-bottom:10px;" placeholder="メールアドレス 必須" name="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                {{-- @if($errors->has('email'))
            ...
            <div>
                ...
                <input id="email_confirmation"  style="margin-bottom:10px;" placeholder="メールアドレスの確認 必須" type="email" class="form-control @error('email') is-invalid @enderror" name="email_confirmation" value="{{ old('email') }}" required autocomplete="email" autofocus>
