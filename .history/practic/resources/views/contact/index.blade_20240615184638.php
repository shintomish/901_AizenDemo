...
@section('content')
    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            ...
            <input id="age" placeholder="年齢 必須"  type="text" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ old('name') }}" required autocomplete="name" autofocus>
