    ...
    <section>
        ...
        <form action="{{ route('contact.confirm') }}" method="POST">
            ...
            <div>
                ...
                <textarea id="body" placeholder="お問い合わせ内容 必須" class="form-control"type="text" @error('body') is-invalid @enderror" name="body" value="{{ old('body') }}" required autocomplete="age" autofocus></textarea>
