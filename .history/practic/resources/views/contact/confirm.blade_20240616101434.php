...
<section>
    ...
    <form action="{{ route('contact.confirm') }}" method="POST">
        @csrf
        <label for="1" style="margin-down:10px;" >確認</label>
        <div>
        ...
        <div>
            ...
            <input id="body" type="text" name="body" class="form-control" value="{{ old('body') }}" disabled>
        </div>

        <div>
            <button type="submit" class="btn btn-primary" name="submitBtnVal" value="back">戻る</button>
            <button type="submit" class="btn btn-primary"name="submitBtnVal" value="complete">送信</button>
        </div>
