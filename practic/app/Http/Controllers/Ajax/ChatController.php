...
class ChatController extends Controller
{
    ...
    public function index(Request $request) { // 新着順にメッセージ一覧を取得
        ...
        // $customer_id = request('customer_id', '');
        // Log::debug('Ajax ChatController index  1$customer_id = ' . print_r($customer_id,true));
        ...
        Log::debug('Ajax ChatController index  2$customer_id = ' . print_r($customer_id,true));
    ...
    public function serch(Request $request)
    {
        ...
        //-------------------------------------------------------------
        $customer_id = $request->Input('customer_id');
        Log::debug('Ajax ChatClientController serch  $customer_id = ' . print_r($customer_id,true));
